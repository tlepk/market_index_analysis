...
### Data visualization 6: Market Crisis - Scatter Plot

เทียบความสัมพันธ์ระหว่าง เปอเซ็นต์ค่าความผันผวน (ATR Percentage) กับ ค่าการเปลี่ยนแปลงของราคาต่อวัน (Price Change Percentage)

- มากกว่า 1 SD สีน้ำเงิน
- มากกว่า 1 SD ถึง 3 SD สีส้ม
- มากกว่า 3 SD สีแดง

Insight ดูการกระจุกตัวของชุดข้อมูล

- *เห็นการกระจุกตัวของค่า ATR อยู่ในช่วง 1% ถึง 2% (ในสภาวะปกติของตลาด)
- *เห็นการกระจุกตัวของค่าการเปลี่ยนแปลงของราคาต่อวันอยู่ในช่วง +5 ถึง -5% (ในสภาวะปกติของตลาด)
- เมื่อเปอเซ็นต์ค่าความผันผวน อยู่ในช่วง น้อยกว่า1sd (สภาวะปกติของตลาด)
- เมื่อเปอเซ็นต์ค่าความผันผวน อยู่ในช่วง มากกว่า1sd - 3sd (มีความเสี่ยงที่จะเกิดวิกฤติ หรือ เกิดตลาดกระทิง)
- เมื่อเปอเซ็นต์ค่าความผันผวน เพิ่มขึ้นเกิน 3sd (เข้าสู่สภาวะวิกฤติ หรือเข้าสู่สภาวะตลาดกระทิง)จะมีความสัมพันธ์ต่อการเปลี่ยนแปลงของราคาดัชนีในหนึ่งวันอย่างมาก ซึ่งจะมีทั้งช่วงตลาดกระทิง และช่วงวิกฤติเศรษฐกิจ

![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/593d3081-72a5-4edf-b83f-d247ce6c5cb2/Untitled.png)
...
ภาพที่ 6 แสดงความสัมพันธ์ระหว่าง ค่าเปอเซ็นต์ค่าความผันผวน (ATR Percentage) กับ ค่าการเปลี่ยนแปลงของราคาต่อวัน (Price Change Percentage)
    - น้อยกว่า 1 sd สีน้ำเงิน
    - มากกว่า 1 sd ถึง 3 sd สีส้ม
    - มากกว่า 3 sd สีแดง
    
- Insight : เราจะเห็นการกระจุกตัวของชุดข้อมูล ดังนี้
    1. ช่วงสภาวะปกติของตลาด)เห็นการกระจุกตัวของค่าเปอเซ็นต์ความผันผวน (ATR Percentage) อยู่ในช่วง 1% ถึง 2%
    และค่าการเปลี่ยนแปลงของราคาต่อวันอยู่ในช่วง+5 ถึง -5%
    2. ช่วงมีความเสี่ยงที่จะเกิดวิกฤติ หรือ เกิดตลาดกระทิง)
    *เห็นการกระจุกตัวของค่าเปอเซ็นต์ความผันผวน (ATR Percentage) อยู่ในช่วง 2% ถึง 4%และค่าการเปลี่ยนแปลงของราคาต่อวันอยู่ในช่วง+5 ถึง -5% เมื่อเปอเซ็นต์ค่าความผันผวน อยู่ในช่วง มากกว่า1sd - 3sd
    3. เมื่อเปอเซ็นต์ค่าความผันผวน เพิ่มขึ้นเกิน 3sd
    *เห็นการกระจุกตัวของค่าเปอเซ็นต์ความผันผวน (ATR Percentage) มากกว่า 4 % ขึ้นไปและค่าการเปลี่ยนแปลงของราคาต่อวันอยู่ในช่วง+10 ถึง -10%

Data visualization 3.1: Distribution of ATR percentage for market indices

Data visualization 3.2: Distribution of ATR percentage for market indices
