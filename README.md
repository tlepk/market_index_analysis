...
(1.ช่วงสภาวะปกติของตลาด)

เห็นการกระจุกตัวของค่าเปอเซ็นต์ความผันผวน (ATR Percentage) อยู่ในช่วง 1% ถึง 2%
และค่าการเปลี่ยนแปลงของราคาต่อวันอยู่ในช่วง+5 ถึง -5%

(2.ช่วงมีความเสี่ยงที่จะเกิดวิกฤติ หรือ เกิดตลาดกระทิง)
*เห็นการกระจุกตัวของค่าเปอเซ็นต์ความผันผวน (ATR Percentage) อยู่ในช่วง 2% ถึง 4%
และค่าการเปลี่ยนแปลงของราคาต่อวันอยู่ในช่วง+5 ถึง -5%

- เมื่อเปอเซ็นต์ค่าความผันผวน อยู่ในช่วง มากกว่า1sd - 3sd

(3.เข้าสู่สภาวะวิกฤติ หรือเข้าสู่สภาวะตลาดกระทิง)

- เมื่อเปอเซ็นต์ค่าความผันผวน เพิ่มขึ้นเกิน 3sd
*เห็นการกระจุกตัวของค่าเปอเซ็นต์ความผันผวน (ATR Percentage) มากกว่า 4 % ขึ้นไป
และค่าการเปลี่ยนแปลงของราคาต่อวันอยู่ในช่วง+10 ถึง -10%

#สร้างรูปและแผนย่อยออกมา#วนลูปซ้ำของแต่ละดัชนีที่ไม่ซ้ำกันใน data-frame และแผนย่อยที่สอดคล้องกัน#กรอง data-frame  ให้มาเป็นดัชนีตัวปัจจุบัน#คำนวณค่าเฉลี่ยและส่วนเบี่ยงเบนมาตรฐาน#กรองข้อมูลระหว่าง -1 SD และ +1 SD#คำนวณจำนวนและเปอร์เซ็นต์ของข้อมูล#สร้างแผนภูมิวงกลมสำหรับจุดข้อมูลภายใน -1 SD และ +1 SD#อัตราส่วนภาพที่เท่ากันทำให้ได้แผนภูมิวงกลมแบบวงกลม#กำหนดสีพื้นหลัง#ลบป้ายกำกับแกน#ตั้งชื่อหัวข้อเรื่องสำหรับพล็อตทั้งหมดนี้#ปรับระยะห่างระหว่างแผนภูมิย่อย#แสดง plot ทั้งหมด  Scatter plot    #สร้างแผนย่อยตารางขนาด 4x3คำนวณค่าเฉลี่ยและส่วนเบี่ยงเบนมาตรฐานสร้างคอลัมน์ใหม่เพื่อระบุตำแหน่งที่สัมพันธ์กับช่วง SDพล็อตกระจายพล็อตด้วยการใช้ colormaps ที่แตกต่างกันเพิ่มจุดสีแดงสำหรับค่าที่อยู่ห่างออกไปมากกว่า 3 ส่วนเบี่ยงเบนมาตรฐานตั้งค่ากำกับแกน x และ yตั้งชื่อเรื่องสำหรับพล็อตย่อยแต่ละอันเพิ่มคำอธิบายสำหรับพื้นที่ที่ไฮไลต์ปรับระยะห่างระหว่างแผนภูมิย่อยแต่ละอันแสดง plot ทั้งหมด

![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/4f5c6d7a-2c81-454c-875c-226e2bf088f9/Untitled.png)

ATR?

- Average True Range (ATR) เป็นเครื่องมือทางเทคนิคที่ไว้วัดความผันผวนของราคาของดัชนีหรือสินทรัพ ที่เราสนใจ

TR?

- True Range (TR) คือ Gap ของความแตกต่างระหว่างราคาเฉลี่ยก่อนหน้าที่เกิดขึ้น

สูตรการคำนวณ ATR โดยปกติจะใช้ค่าเฉลี่ย (Average) อยู่ที่ระดับ 14 วัน(ซึ่งเป็นค่ามาตราฐาน)ในการคำนวณ

ทั้งสองตัวนี้ ATR และ TR คือเครื่องมือที่เอามาไว้ในการช่วยตัดสินใจในการซื้อขายสินทรัพ โดยจะใช้ในการคำนวนในการหาดัชนีเฉลี่ยของสินทรัพนั้นๆได้ โดย range ที่นำมาใช้ในการช่วยการสินใจของผู้เทรด

# Calculate Price Change per day คำนวนราคาที่เปลี่ยนแปลงในหนึ่งวัน

# Calculate price change percentage คำนวนราคาที่เปลี่ยนแปลง ให้เป็นรูปของเปอร์เซ็น

# Calculate volume change per day คำนวนปริมานการซื้อขายในหนึ่งวัน

# Calculate volume change percentage คำนวณปริมาณการซื้อขายในรูปแบบของเปอร์เซ็น

# Calculate true range highest price minus lowest price คำนวณ ค่า TR

# Calculate true range current highest price minus previous close price

# Calculate true range current lowest price minus previous previous close price

# Calculate max true range คำนวนหาค่า max ของ TR

# Calculate average true range คำนวนหาค่าเฉลี่ยของ TR

# Calculate ATR Change คำนวณความเปลี่ยนแปลงของค่า ATR

# สร้างแผนภูมิและ plot ย่อยออกมา

#วนลูปซ้ำของแต่ละดัชนีที่ไม่ซ้ำกันใน data-frame และแผนย่อยที่สอดคล้องกัน

#กรอง data-frame  ให้มาเป็นดัชนีตัวปัจจุบัน

#ทำการกระจายลงไปใน plot ของ ATR%

#ตั้งค่าแสดงปริมาณจำนวนของกราฟที่ต้องการแสดง

#เพิ่มเส้นค่าเฉลี่ยลงไปในกราฟ

#เพิ่ม highlight ในพื้นที่บนกราฟ โดยเป็นค่าของ standard deviation

#เพิ่มแถบแสดงค่าลงบนกราฟ

#ตั้งชื่อหัวเรื่อง

#ปรับพื้นที่ระหว่าง sub-plot
